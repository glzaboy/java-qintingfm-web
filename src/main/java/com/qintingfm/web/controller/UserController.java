...
public class UserController {
    ...
    @ResponseBody
    public AjaxDto registerPost(@RequestParam(value = "email") String email, @RequestParam(value = "userName") String userName, @RequestParam(value = "tel") String tel) {
